    ...
    <section className="relative text-white border-b-2 border-[#8B8B95] z-10 ">
      ...
      <div className="flex flex-col md:flex-row md:w-full justify-center items-center">
        <div className="flex flex-col mt-0 p-6 md:p-36 w-full z-20">
          <div className="w-[30rem] h-[2.5rem] mb-32 bg-slate-700">
            <h2 className="text-2xl pt-1.5 text-white font-bold">
              Ansan High Class Premium Karaoke
            </h2>
          </div>
          <h2 className="text-4xl font-bold mb-4">안산 미르노래광장</h2>
          <div className="mb-5 text-pink">
            <h3 className="mb-1 text-2xl">안산 최고 모델급 도우미 다수</h3>
            <h3 className="mb-1 text-2xl">저렴한 주대</h3>
            <h3 className="mb-1 text-2xl">편안한 시설</h3>
          </div>
          <p className="w-full lg:text-2xl">
            ...
            <br />
            고객님 취향에 맞춰 만족하실때까지 최선을 다해 즐거운 시간을 보내실
            수 있도록 노력하고 있습니다.
          </p>
        </div>
        <Image
